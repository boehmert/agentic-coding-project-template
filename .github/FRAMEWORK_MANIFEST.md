...
|---|---|---|---|
| architect | `agents/architect.agent.md` | ACTIVE | System design, ADRs, tech decisions |
...
| security-reviewer | `agents/security-reviewer.agent.md` | ACTIVE | Security analysis |
